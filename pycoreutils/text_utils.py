...
class TextUtils:
    ...
    @staticmethod
    def grep(pattern: str, filepath: Union[str, Path], 
    ...
    @staticmethod
    def nl(filepath: Union[str, Path], start: int = 1, 
    ...
    @staticmethod
    def sort_lines(lines: List[str], reverse: bool = False, 
    ...
    def replace(text: str, pattern: str, replacement: str, 
                count: int = 0, ignore_case: bool = False) -> str:
        """
