...
class ArchiveUtils:
    ...
    @staticmethod
    def tar_create(archive_path: Union[str, Path], 
    ...
    @staticmethod
    def tar_extract(archive_path: Union[str, Path], 
                    extract_to: Union[str, Path] = ".") -> List[str]:
        """
        Extract tar archive.
    ...
    @staticmethod
    def zip_create(archive_path: Union[str, Path], 
                   files: List[Union[str, Path]],
    ...
    @staticmethod
    def zip_extract(archive_path: Union[str, Path], 
                    extract_to: Union[str, Path] = ".") -> List[str]:
        """
        Extract zip archive.
    ...
    @staticmethod
    def gzip_file(file_path: Union[str, Path], 
    ...
    @staticmethod
    def gunzip_file(file_path: Union[str, Path], 
                    output_path: Optional[Union[str, Path]] = None) -> str:
        """
